...
const EMBEDDED_TRANSLATIONS = {
    'zh-TW': {
        ...
        subtitle: '使用 Reverse Alpha Blending 技術<strong>無損</strong>移除 Gemini Nano Banana 與 Gemini Omni 影片/圖片浮水印 · 100% 純前端本地處理',
        metaDescription: '使用 Reverse Alpha Blending 技術無損移除 Gemini Nano Banana 與 Gemini Omni 影片及圖片浮水印的純前端工具，100% 本地處理保護隱私。',
        blog: 'Blog', toggleTheme: '切換主題',
        dropText: '拖放圖片到這裡，或點擊選擇檔案',
        dropHint: '支援 PNG、JPG、MP4、WebM 格式，可批次上傳',
        step1Title: '上傳圖片', step1Desc: '拖放或點擊選擇帶有浮水印的圖片或影片',
        step2Title: '自動處理', step2Desc: '系統自動偵測並移除浮水印',
        step3Title: '下載結果', step3Desc: '預覽並下載處理完成的圖片或影片',
        ...
        toastSuccess: '處理完成：{count} 個檔案已處理',
        toastPartial: '處理完成：{success} 個成功，{fail} 個失敗',
        language: '語言',
        forceRemove: '強制移除',
        forceRemoveDesc: '即便未偵測到浮水印也進行計算 (適用於偵測失敗時)',
        watermarkMargin: '浮水印邊距',
        watermarkMarginDesc: '調整右下角邊距 (0 表示自動)',
        watermarkOpacity: '浮水印強度',
        watermarkOpacityDesc: '調整混色透明度強度 (0 表示自動)',
        auto: '自動',
        videoPreviewBadge: '預覽模式',
        startConversion: '開始轉換',
        videoPreview: '影片轉換預覽',
        videoPreviewDesc: '上傳影片時彈出預覽視窗以調整邊距與強度',
        videoPreviewTitle: '影片轉換預覽',
        cancel: '取消'
    },
    'en': {
        title: 'Gemini Nano Banana Watermark Remover',
        subtitle: 'Remove Gemini Nano Banana & Gemini Omni video/image watermarks <strong>losslessly</strong> using Reverse Alpha Blending · 100% Local',
        metaDescription: 'A client-side tool for losslessly removing Gemini Nano Banana and Gemini Omni video & image watermarks using Reverse Alpha Blending. 100% local and private.',
        blog: 'Blog', toggleTheme: 'Toggle Theme',
        dropText: 'Drag & drop images here, or click to select files',
        dropHint: 'Supports PNG, JPG, MP4, WebM formats. Batch upload available',
        step1Title: 'Upload Images', step1Desc: 'Drag & drop or click to select watermarked images or videos',
        step2Title: 'Auto Process', step2Desc: 'System automatically detects and removes watermarks',
        step3Title: 'Download Results', step3Desc: 'Preview and download processed images or videos',
        ...
        toastSuccess: 'Completed: {count} files processed',
        ...
        watermarkMarginDesc: 'Adjust bottom-right margin (0 for auto)',
        watermarkOpacity: 'Watermark Intensity',
        watermarkOpacityDesc: 'Adjust alpha blending intensity (0 for auto)',
        auto: 'Auto',
        videoPreviewBadge: 'Preview Mode',
        startConversion: 'Start Conversion',
        videoPreview: 'Video Conversion Preview',
        videoPreviewDesc: 'Show preview window to adjust margin and intensity upon video upload',
        videoPreviewTitle: 'Video Conversion Preview',
        cancel: 'Cancel'
    }
};
